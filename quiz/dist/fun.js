...
//*****************************************************************************
var question1 = {
                  question: "¿Cual comando se necesita para crear los contenedores o servicios que usara nuestra app?",
                  answers: ["Dokku mysql:create stagingDB", "Dokku create: stagingDB", "Dokku stagingDB:create"],
                  correct: 0
                };

var question2 = {
                  question: "¿Como enlazar los servicios a nuestra app?",
                  answers: ["Dokku mysql:link stagingDB", "Dokku mysql:link stagingDB staging", "Dokku mysql:stagingDB staging"],
                  correct: 1
                };

var question3 = {
                  question: "¿Cual comando se utiliza para crear una app?",
                  answers: ["dokku apps:ini staging", "dokku apps:create staging", "dokku apps:get staging"],
                  correct: 1
                }

var question4 = {
                  question: "¿Como establer las variables de entorno para nuestra app?",
                  answers: ["Dokku config:set staging USERNAME=... PASSWORD=...", "Dokku config: USERNAME=... PASSWORD=...", "Dokku config:set staging"],
                  correct: 0
                };

var question5 = {
                  question: "¿Es posible deshabilitar un plugin luego de ser instalado?",
                  answers: ["True", "False"],
                  correct: 1
                };

var question6 = {
                   question: "Conexion remota desde el ordenador para realizar deploy a nuestra app",
                  answers: ["1) Realiza un Push de rama local a Dokku, 2)Agregamos el repositorio remoto para hacer despliegue en el servidor dokku",
                   "No es posible crear la conexion remota",
                   "1)Agregamos el repositorio remoto para hacer despliegue en el servidor dokku, 2) Realiza un Push de rama local a Dokku"],
                  correct: 2
                };

var question7 = {
                  question: "¿Un servidor requiere mantenimiento?",
                  answers: ["True", "False"],
                  correct: 0
                };
